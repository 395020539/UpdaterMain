...
class MyDxlCommand:
    ...
    def find_value(self, doors_project_path, data_name, module_name, path_suffix):
        mydbo = MyDataBaseHander()
        data_module_path = mydbo.query_path(data_name, module_name)
        doors_module = '"{}{}"'.format(doors_project_path, data_module_path + path_suffix)
        print("doors_module = ", doors_module)
...
if __name__ == '__main__':
    ...
    doors_project_path = "LSCNS_Training"
    data_name = "Yawvelocity_Max_DriveTorqueSteerCompensation"
    module_name = "Data test 2"
    path_suffix = ""
    dxl_command = dxl_commands.find_value(doors_project_path, data_name, module_name, path_suffix)
